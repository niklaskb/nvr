...
def get_video_stream_mjpeg():
    return Response(http_stream(stream_camera),
...
if __name__ == "__main__":
    ...
    stream_camera = StreamCamera(app.logger, camera_url_stream, max_unread_frames, frame_sleep, stream_width, stream_height)
    capture_camera = CaptureCamera(app.logger, camera_url_capture, file_path, capture_timeout)
